...
```bash
hdiutil create -volname RemoteShare -srcfolder src-tauri/target/release/bundle/macos/RemoteShare.app -ov -format UDZO src-tauri/target/release/bundle/dmg/RemoteShare_0.1.7_aarch64.dmg
```
