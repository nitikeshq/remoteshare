...
| macOS model/version | Name the physical Mac and OS version, such as `MacBook Pro M2 / macOS 15`. |
| Windows model/version | Name the physical Windows computer and OS version, such as `Windows laptop PC / Windows 11`. |
...
| macOS firewall status | Include allowed/successful status with TCP `44777` and UDP `44778`. |
| Windows firewall status | Include allowed/successful status with TCP `44777` and UDP `44778`. |
