...
12. Confirm Notes show \`Blocking issues: none\`, identify screenshots or logs captured, and show \`Retest required: no\`; unresolved blocking issues, missing captured-evidence notes, or required retests fail release readiness.
