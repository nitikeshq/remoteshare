...
13. Record capture start/stop evidence and paste receiver Input Transport row \`Copy\` output for accepted incoming mouse move, mouse click, scroll, and key events on the Windows receiver.
