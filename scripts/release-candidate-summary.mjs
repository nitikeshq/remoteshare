...
9. After restart/wake, use the trusted row reconnect \`Copy\` button to paste \`Auto reconnect: enabled\`, \`Check: reachable\`, measured latency, last-seen timing, endpoint source, endpoint, last failure, and recovery evidence. The copied reconnect output must still include last-seen timing, endpoint source, endpoint, last failure, and recovery evidence.
