...
check("Release summary validates manifest timestamp and artifact shape", releaseSummary.includes("validateManifestArtifactTypes") && releaseSummary.includes("validateReleaseManifestArtifact") && releaseSummary.includes("manifest.generatedAt") && fs.readFileSync("scripts/test-release-summary.mjs", "utf8").includes("missing-generated-at") && fs.readFileSync("scripts/test-release-summary.mjs", "utf8").includes("invalid-generated-at"));
