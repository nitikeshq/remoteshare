...
check("LAN smoke report verifier enforces concrete failure reason evidence", lanSmokeVerifier.includes("requireFailureReasonEvidence") && lanSmokeVerifier.includes("requireManualFailureReasonEvidence") && lanSmokeVerifier.includes("failure reason evidence must say none/no failure") && lanSmokeVerifier.includes("manual IP, Set IP / Verify IP, copied endpoint, TCP 44777, or firewall recovery path") && fs.readFileSync("scripts/test-lan-smoke-report-verifier.mjs", "utf8").includes("vague failure reason evidence should fail") && fs.readFileSync("scripts/test-lan-smoke-report-verifier.mjs", "utf8").includes("qualified no-failure evidence should pass") && fs.readFileSync("scripts/test-lan-smoke-report-verifier.mjs", "utf8").includes("ambiguous no-failure evidence should fail") && fs.readFileSync("scripts/test-lan-smoke-report-verifier.mjs", "utf8").includes("vague manual failure reason should fail") && fs.readFileSync("scripts/test-lan-smoke-report-verifier.mjs", "utf8").includes("manual IP recovery failure reason should pass"));
