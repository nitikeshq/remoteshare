...
check("Runtime validates trusted endpoint recording", runtimeStore.includes("trusted_connection_recording_normalizes_and_rejects_invalid_endpoints") && runtimeStore.includes("completed_pairing_normalizes_trusted_endpoint_before_saving") && runtimeStore.includes("completed_pairing_rejects_invalid_trusted_endpoint") && runtimeStore.includes("record_trusted_connection") && runtimeStore.includes("normalized_endpoint(&endpoint)") && runtimeStore.includes("normalized_endpoint(&pairing.endpoint)"));
