...
check("Runtime ignores public trusted failures while private guard is enabled", runtimeStore.includes("private_network_guard_ignores_public_connection_failures") && runtimeStore.includes("record_trusted_connection_failure") && runtimeStore.includes("private_guard_allows_endpoint") && runtimeStore.includes("state.persisted.settings.private_network_only"));
