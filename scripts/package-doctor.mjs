...
check("First LAN runbook documents role-aware setup checklist", firstLanTest.includes("setup checklist is role-aware") && firstLanTest.includes("on macOS it expects the sender role and Mac input permissions") && firstLanTest.includes("on Windows it expects the receiver role and Windows injection readiness"));
