...
check("UI bases failure recovery hints on failed endpoint source", appUi.includes("failure.endpointSource === \"saved\"") && appUi.includes("failure.endpointSource === \"discovery\"") && appUi.includes("Saved endpoint may be stale") && runtimeStore.includes("pub endpoint_source: EndpointSource") && runtimeStore.includes("endpoint_source: failure_endpoint_source") && runtimeStore.includes("fn failure_endpoint_source") && runtimeStore.includes("matches!(failure.endpoint_source, super::EndpointSource::Saved)"));
